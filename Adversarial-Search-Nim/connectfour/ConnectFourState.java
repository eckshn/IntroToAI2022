...
public class ConnectFourState implements Cloneable {
	...
	public ConnectFourState(String[] board, String playerToMove){
		this.board = board;
	...
	public ConnectFourState clone() {
		ConnectFourState copy = null;
		try {
			copy = (ConnectFourState) super.clone();
	...
	public boolean equals(Object anObj) {
		if (anObj != null && anObj.getClass() == getClass()) {
			ConnectFourState anotherState = (ConnectFourState) anObj;
			for (int i = 0; i < 9; i++) {
